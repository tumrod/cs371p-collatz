...
int collatz_cache (int i, int j) {
    ...
    if ((j > 100) && (j < 1000) && (j-i > 100))
        max_cycle_len = meta_cache_helper (i, j, LESS_THAN_1000, 100);

    else if ((i > 1000) && (j-i > 1000))
        max_cycle_len = meta_cache_helper (i, j, MORE_THAN_1000, 1000);

    else
        max_cycle_len = collatz_eval (i, j);
